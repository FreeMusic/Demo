...
- (void)viewDidLoad {
    ...
    [config.userContentController addScriptMessageHandler:[[WeakScriptMessageDelegate alloc] initWithDelegate:self] name:@"scan"];
    //注入js
...
//    [_webview loadRequest:[NSURLRequest requestWithURL:rul]];
    NSURLRequest *request = [[NSURLRequest alloc] initWithURL:[NSURL URLWithString:@"http://mobile.hcjinfu.com:9083/html/newsWelfare.html"]];
