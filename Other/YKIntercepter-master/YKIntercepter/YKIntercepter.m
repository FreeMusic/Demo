...
- (instancetype)init {
    ...
    if (self) {
        ...
        [objc_getClass("__NSArrayI") swizzleMethod:@selector(objectAtIndexedSubscript:) withMethod:@selector(sxy_objectAtIndexedSubscript:) error:nil];
        //替换NSMutableArray方法
        ...
        [objc_getClass("__NSArrayM") swizzleMethod:@selector(objectAtIndexedSubscript:) withMethod:@selector(sxy_objectAtIndexedSubscript:) error:nil];
    }
    return self;
}
